...
export default function Home() {
  ...
  // ✅ Fallback to '/api' so you never get '/undefined/...'
  const API_BASE = (process.env.NEXT_PUBLIC_API_URL && process.env.NEXT_PUBLIC_API_URL.trim()) || '/api';
  ...
  async function deleteCategory(category) {
    ...
    // ✅ Works whether the row has _id or id (DataGrid uses id)
